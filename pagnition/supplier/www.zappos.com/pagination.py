...
def pagnition():
    df=pd.read_csv("pagnition/supplier/www.zappos.com/zappos_com.csv",usecols=['Category URL','Product Count'])
    ...
    savedf.to_csv("pagnition/output/zappos.csv",index=False)
