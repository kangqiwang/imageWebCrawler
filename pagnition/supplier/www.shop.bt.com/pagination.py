...
def pagnition():
    df=pd.read_csv("pagnition/input/shop_bt_com.csv",usecols=['Category URL","Category Name","First Page","Last Page","Source Domain","Product Count'])
