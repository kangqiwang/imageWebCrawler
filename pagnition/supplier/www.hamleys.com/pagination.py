...
def pagnition():
    df=pd.read_csv("pagnition/input/hamleys_com.csv",usecols=['Category URL","Category Name","First Page","Last Page","Source Domain","Product Count'])
