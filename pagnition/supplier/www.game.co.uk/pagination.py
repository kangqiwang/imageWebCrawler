...
def pagnition():
    df=pd.read_csv("pagnition/input/game_co.csv",usecols=['Category URL","Category Name","First Page","Last Page","Source Domain","Product Count'])
