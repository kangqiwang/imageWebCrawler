...
def pagnition():
    df=pd.read_csv("pagnition/input/halfpriceperfumes_co.csv",usecols=['Category URL','Product Count'])
    ...
    savedf.to_csv("pagnition/output/halfpriceperfumes_co.csv",index=False)
