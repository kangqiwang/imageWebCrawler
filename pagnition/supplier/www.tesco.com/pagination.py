...
def pagnition():
    df=pd.read_csv("pagnition/input/tesco_com.csv",usecols=['Category URL","Category Name","First Page","Last Page","Source Domain","Product Count'])
    ...
    savedf.to_csv("pagnition/output/tesco_com.csv",index=False)
